...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "face-detection-for-atten-6b8a0.appspot.com"
})
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                datetimeObject = datetime.strptime(studentInfo['Last_attended_time'],
                                                   "%Y-%m-%d %H:%M:%S")
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    cv2.putText(imgBackground, str(studentInfo['Attendance']), (861, 125), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['Branch']), (1006, 550), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(id), (1006, 493), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['Marks']), (910, 625), cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
